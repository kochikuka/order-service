...
public class BytesvcTestContainer extends TestContainer {

    public BytesvcTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/bytebratsk/bytesvc/app.properties",
    ...
    public static class Common extends BytesvcTestContainer {

        public static final BytesvcTestContainer.Common INSTANCE = new BytesvcTestContainer.Common();
